...
matrix = np.load('matrix_' + str(row) + 'x' + str(col) + '_LAPD_area' + '.npy')
...
start_day = date(2016,01,01)#year,month ,date
...
plt.show()
np.save( 'matrix_' + str(time_period) + 'h_' + str(row) + 'x' + str(col) + '_LAPD_area', day_matrix)